...
function DifficultyRow({
  ...
  return (
    <View style={[styles.diffRow, divider && styles.diffRowDivider]}>
      <Text style={[styles.diffOpLabel, !enabled && styles.textDisabled]}>
        {opLabel}
      </Text>
      <View style={styles.diffCol}>
        <Text style={[styles.digitLabel, !enabled && styles.textDisabled]}>
          最少位数
        </Text>
        <View style={styles.stepperRow}>
          ...
          />
          <Text style={[styles.stepperValue, !enabled && styles.textDisabled]}>
            {minDigits}
          </Text>
          <StepButton
            symbol="+"
  ...
  const adjustDigits = (
    ...
    setSettings((s) => {
      ...
      return {
        ...
        difficulty: {
          ...s.difficulty,
          [op]: { minDigits: min, maxDigits: max },
        },
      };
    });
  };
