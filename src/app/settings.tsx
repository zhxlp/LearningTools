          ...
          <View style={styles.digitsRow}>
            <View style={styles.digitCol}>
              ...
              <View style={styles.stepperRow}>
                <StepButton
                  symbol="−"
                  disabled={minMinusDisabled}
                  onPress={() => adjustDigits("min", -1)}
                />
                <Text style={styles.stepperValue}>{settings.digits.min}</Text>
                <StepButton
                  symbol="+"
                  disabled={minPlusDisabled}
                  onPress={() => adjustDigits("min", 1)}
                />
              </View>
            </View>
            <View style={styles.digitCol}>
              ...
              <View style={styles.stepperRow}>
                <StepButton
                  symbol="−"
                  disabled={maxMinusDisabled}
                  onPress={() => adjustDigits("max", -1)}
                />
                <Text style={styles.stepperValue}>{settings.digits.max}</Text>
                <StepButton
                  symbol="+"
                  disabled={maxPlusDisabled}
                  onPress={() => adjustDigits("max", 1)}
                />
              </View>
            </View>
