...
export const CalculationBoard = forwardRef<
  CalculationBoardHandle,
...
>(function CalculationBoard(
  ...
  const getBoardSnapshot = useCallback(
    (): DrawingPadSnapshot | null => padRef.current?.getSnapshot() ?? null,
    [],
  );
      ...
      <View style={styles.leftCard}>
          ...
          <View style={styles.toolbar}>
            ...
            {showStyleControls && (
              <TouchableOpacity
                style={[
                  styles.toolButton,
                  styleOpen && styles.toolButtonActive,
                ]}
            ...
            <DrawingPad ref={padRef} tool={tool} canvasColor="#ffffff">
              ...
              <View
                style={{
                  ...
                  alignItems: "center",
                  paddingTop: columnarStyle.padTop,
                }}
              >
        ...
        {showStyleControls && styleOpen && (
          <View style={styles.stylePanel}>
            ...
            <Stepper
              label="顶距"
              value={columnarStyle.padTop}
              min={STYLE_LIMITS.padTop.min}
              max={STYLE_LIMITS.padTop.max}
              step={STYLE_LIMITS.padTop.step}
              onChange={(v) => changeStyle("padTop", v)}
            />
          </View>
        )}
      </View>
